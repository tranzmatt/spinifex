...
func SetIpAddressType(input *elbv2.SetIpAddressTypeInput, natsConn *nats.Conn, accountID string) (elbv2.SetIpAddressTypeOutput, error) {
	...
	result, err := svc.SetIpAddressType(input, accountID)
	if err != nil {
		return output, err
	}
